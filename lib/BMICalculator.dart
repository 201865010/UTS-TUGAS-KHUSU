...
void _calculateBMI()
{
  ...
  if(height!=null && weight!=null)
  {
    setState(() {
      ...
      if(_calculation<18.5){
        ...
        _result='Anda termasuk dalam kategori normal';
        ...
        _result='Anda termasuk dalam kategori obesitas1';
      }else if(_calculation>=35.0 && _calculation<=39.9){
        _result='Anda termasuk dalam kategori obesitas2';
      }else {
        _result='Anda termasuk dalam kategori obesitas3';
      }
    });
  }
}
 ...
 @override
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: new AppBar(backgroundColor: Colors.blue[800],title: new Text('Kalkulator BMI'),),
      body: new ListView(
